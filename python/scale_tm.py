# scale_tm.py
# Calcula N2 com base no tempo de mistura (t_m) constante.

def calculate_n2(n1, di1, di2):
    """
    Calcula N2 para manter o tempo de mistura constante.
    ...
    # Equação: N2 = N1 * (Di2 / Di1)^(1/4)
    n2 = n1 * ((di2 / di1)**(1.0/4.0))
    return n2